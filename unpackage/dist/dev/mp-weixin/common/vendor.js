...
const globalStyle = {
  ...
  navigationBarTitleText: "瑶一瑶小可爱的表情包",
  ...
  list: [
    {
      ...
      iconPath: "static/灰色文件夹.png",
      selectedIconPath: "static/橙色文件夹.png",
      text: "全部"
    },
    {
      pagePath: "pages/tabBar/classify/classify",
      iconPath: "static/灰色列表图标.png",
      selectedIconPath: "static/橙色列表.png",
      text: "分类"
    },
    {
      pagePath: "pages/tabBar/other/other",
      iconPath: "static/已关注灰色.png",
      selectedIconPath: "static/已关注橙色.png",
      text: "其他"
    },
    {
      pagePath: "pages/tabBar/write/write",
      iconPath: "static/icon-edit-grey.png",
      selectedIconPath: "static/icon-edit-yell.png",
      text: "树洞"
    }
  ]
};
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.162.119"\n    ],\n    "debugPort": 9001,\n    "initialLaunchType": "local",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"bqb-dev","spaceId":"mp-a2a30525-c676-407e-aaad-491b8272ba92","clientSecret":"I2Btxmu5iFDfcPixYjrtXg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__F6D4375";
} catch (e2) {
